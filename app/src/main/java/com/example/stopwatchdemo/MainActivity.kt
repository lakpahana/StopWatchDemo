...
import com.example.stopwatchdemo.StopWatchService.Companion.CURRENT_TIME
...
class MainActivity : AppCompatActivity() {
    ...
    private fun reset(){
        stop()
        time = 00.00
        binding.tvTime.text = getFormattedTAime(time)
    }
    ...
    private fun getFormattedTAime(time:Double):String{
